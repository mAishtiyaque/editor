...
import { MdFormatBold, MdFormatItalic, MdDeleteForever, MdFormatUnderlined, MdFormatQuote, MdFormatAlignLeft, MdFormatAlignCenter, MdFormatAlignRight, MdFormatListNumbered, MdFormatListBulleted,MdInsertLink,MdVideoLibrary,MdImage,MdAdd} from 'react-icons/md'
...
const iconList={
    ...
    add:<MdAdd size={20}/>,
    delete:<MdDeleteForever size={20} color={"red"}/>,
